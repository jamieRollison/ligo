      ...
      {#if $isAuthenticated}
        <li class="mt-4 md:mt-0 ml-6 md:ml-0">
          ...
          <a
            href="/"
            on:click={logout}
            class="font-WorkSans text-sm px-6 py-2 md:mt-0 leading-none border rounded text-white border-white hover:border-transparent hover:text-teal-500 hover:bg-white mt-4 lg:mt-0"
          >
            Log out</a
          >
        </li>
