  ...
  <form method="POST">
    ...
    <div class="flex flex-col mt-4">
      <label class="font-WorkSans text-white" for="swag"
        >Did you provide guests with free 'swag'?
      </label>
      ...
      {#if $form.swag === "Yes"}
        ...
        >
          <label class="font-WorkSans text-gray-600 mb-1" for="shirt"
            >Were guests given a free shirt upon entry?
          </label>
          <select
            class="font-WorkSans text-black rounded-sm h-8"
            id="shirt"
          ...
          <label class="font-WorkSans text-gray-600 mb-1 mt-2" for="sweater"
            >Were guests given a heavier piece of clothing upon entry?
          </label>
          ...
          <label class="font-WorkSans text-gray-600 mb-1 mt-2" for="paper"
            >Were guests given a paper brochure, sticker, or other paper item
            upon entry?
          </label>
          <select
            class="font-WorkSans text-black rounded-sm h-8"
