import { c as create_ssr_component, f as compute_rest_props, h as createEventDispatcher, d as add_attribute, e as escape, j as spread, k as escape_object, l as escape_attribute_value, v as validate_component, o as each, p as compute_slots } from "../../chunks/index2.js";
import { S as SEO } from "../../chunks/SEO.js";
import fuzzy from "fuzzy";
/* empty css                                                             */const Search_svelte_svelte_type_style_lang = "";
const css$3 = {
...
<div class="${"flex flex-col items-center md:flex-row "}"><img class="${"w-60 lg:w-1/2 svelte-6jq58b"}" src="${"/assets/recycle_2.png"}" alt="${"recycle_2 throwing out trash"}">
	<div class="${"flex flex-col"}"><h1 class="${"font-Jomhuria text-9xl text-white"}">Ligo</h1>
		<p class="${"font-WorkSans text-white text-2xl"}">Your new tool to calculate the environmental impact of your coordinated event, and helping the
			environment through analyzing your carbon footprint.
		</p>
		${validate_component(SearchBarAndButton, "SearchBarAndButton").$$render($$result, { events: data.events }, {}, {})}</div>
</div>`;
});
export {
  Page as default
