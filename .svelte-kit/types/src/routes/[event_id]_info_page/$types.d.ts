...
type RouteId = '/[event_id]_info_page';
...
export type PageServerData = Expand<OptionalUnion<EnsureDefined<Kit.AwaitedProperties<Awaited<ReturnType<typeof import('../../../../../src/routes/[event_id]_info_page/+page.server.js').load>>>>>>;
