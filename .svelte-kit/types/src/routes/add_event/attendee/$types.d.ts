...
type RouteParams = {  }
type RouteId = '/add_event/attendee';
...
export type ActionData = Expand<Kit.AwaitedActions<typeof import('../../../../../../src/routes/add_event/attendee/+page.server.js').actions>> | null;
